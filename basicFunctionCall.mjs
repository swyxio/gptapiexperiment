...
const tagSchema = z.object({
  title: z.string({ description: "title of song" }).min(1),
  description: z.string({ description: "Music critic's description of song" }).min(1),
  date: z.string({ description: "Music critic's description of song" }).min(1),
})
...
const tools = [
  {
    ...
    function: {
      name: "get_artist",
      description: "Choose a famous 1980s pop artist, and give me 3 songs by them",
      parameters: zodToJsonSchema(z.object({
        artist: z.string({ description: "The name of the artist" }),
        songs: z.array(tagSchema).min(3).max(6),
      }).required())
    }
  }
]
...
// response2 {
//   name: 'get_artist',
//   arguments: '{"artist":"Michael Jackson","songs":[{"title":"","description":"","date":""},{"title":"","description":"","date":""},{"title":"","description":"","date":""}]}'
// }


// // JSON MODE - is unreliable
